...
cfb_ei %>%
  ...
  labs(x = "Week", 
       ...
       title = "Average Excitement does not fluctuate per week") +
  geom_errorbar(aes(ymin=avg_excitement-se, ymax=avg_excitement+se), width=.2,
...
```{r}
cfb_ei[order(-cfb_ei$excitement_index),]
```
